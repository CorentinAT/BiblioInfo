...
bdd.create_document(conn, ("Le Seigneur des Anneaux", true, "SF/FANT"))
...
bdd.create_document(conn, ("Harry Potter à l'école des sorciers", true, "FICT"))
...
bdd.create_document(conn, ("Le Petit Prince", true, "FICT"))
...
bdd.create_document(conn, ("Les Misérables", true, "FICT"))
...
bdd.create_document(conn, ("Orgueil et Préjugés", true, "FICT"))
...
bdd.create_document(conn, ("Crime et Châtiment", true, "FICT"))
...
bdd.create_document(conn, ("Le Comte de Monte-Cristo", true, "FICT"))
...
bdd.create_document(conn, ("Les Quatre Filles du docteur March", true, "FICT"))
...
bdd.create_document(conn, ("Le Nom de la Rose", true, "FICT"))
...
bdd.create_document(conn, ("Le Parfum", true, "FICT"))
...
bdd.create_document(conn, ("Les Trois Mousquetaires", true, "FICT"))
...
bdd.create_document(conn, ("L'Étranger", true, "FICT"))
...
bdd.create_document(conn, ("Moby Dick", true, "FICT"))
...
bdd.create_document(conn, ("L'Odyssée", true, "FICT"))
...
bdd.create_document(conn, ("Le Rouge et le Noir", true, "FICT"))
...
bdd.create_document(conn, ("Don Quichotte", true, "FICT"))
...
bdd.create_document(conn, ("Anna Karenina", true, "FICT"))
...
bdd.create_document(conn, ("Les Fleurs du Mal", true, "POES"))
...
bdd.create_document(conn, ("Guerre et Paix", true, "FICT"))
...
bdd.create_document(conn, ("Les Hauts de Hurlevent", true, "FICT"))
...
bdd.create_document(conn, ("Le Journal d'Anne Frank", true, "BIO"))
...
bdd.create_document(conn, ("Les Aventures de Tom Sawyer", true, "FICT"))
...
bdd.create_document(conn, ("Vingt mille lieues sous les mers", true, "FICT"))
...
bdd.create_document(conn, ("Le Petit Nicolas", true, "FICT"))
...
bdd.create_document(conn, ("Les Piliers de la Terre", true, "FICT"))
...
bdd.create_document(conn, ("Le Portrait de Dorian Gray", true, "FICT"))
...
bdd.create_document(conn, ("Le Silence des Agneaux", true, "THRILL"))
...
bdd.create_document(conn, ("Les Raisins de la colère", true, "FICT"))
...
bdd.create_document(conn, ("Les Aventures d'Alice au pays des merveilles", true, "FICT"))
...
bdd.create_document(conn, ("Le Guépard", true, "FICT"))
...
bdd.create_document(conn, ("Le Journal de Bridget Jones", true, "FICT"))
...
bdd.create_document(conn, ("L'Alchimiste", true, "FICT"))
...
bdd.create_document(conn, ("Cent ans de solitude", true, "FICT"))
...
bdd.create_document(conn, ("1984", true, "FICT"))
